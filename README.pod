...
of the variable with the last occurrence. Currently the names include a number
that is incremented for each variable. A more flexible way to choose names
is on the todo list.
